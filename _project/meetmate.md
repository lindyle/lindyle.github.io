...
overview: Decision support systems rely on accurate modeling of user preferences. However, the uncertainty and inconsistency of human preferences complicates the preference elicitation process between systems and users. MeetMate combined Large Language Models (LLMs) and Constraint Programming to facilitate interactive decision support. 
